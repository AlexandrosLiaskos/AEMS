    ...
    constructor() {
        ...
        if (this.isConfigured) {
            try {
                ...
                console.log('✅ AI Extractor configured successfully');
            } catch (error) {
                console.warn('⚠️ AI Extractor configuration failed:', error.message);
                this.isConfigured = false;
            }
        } else {
            console.log('📝 AI Extractor not configured - API key missing');
            this.openai = null;
            this.llm = null;
        }
